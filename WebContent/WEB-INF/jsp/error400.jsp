   ...
   <!-- ----------------------AJOUT NEW SUPER NAVBAR BOT------------------------- -->
	...
	<div class="container">
		...
		<br><ol class="breadcrumb">
			...
			<li class="active">Page non accessible</li>
		</ol><br>
				...
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							<h3 class="thin text-center"><span class="redText">La page que vous souhaitez joindre n'existe plus.</span></h3>
							<p class="text-center text-muted">
								Vous pouvez revenir en arrière en suivant <a href="javascript:history.back()">ce lien</a>.
